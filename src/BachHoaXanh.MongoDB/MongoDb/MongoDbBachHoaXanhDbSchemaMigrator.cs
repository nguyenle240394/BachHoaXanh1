...
public class MongoDbBachHoaXanhDbSchemaMigrator : IBachHoaXanhDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbBachHoaXanhDbSchemaMigrator(IServiceProvider serviceProvider)
    {
